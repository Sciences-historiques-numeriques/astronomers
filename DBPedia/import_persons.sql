...
SELECT birthYear, person_uri, persname, "Importé le 21 janvier 2026 depuis le résultat d'une requête SPARQL sur DBPedia, cf. astronomers/DBpedia_importer_dans_base_personnelle"
FROM dbp_liste_personnes lp ;   
