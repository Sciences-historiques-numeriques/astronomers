...
Then export the data from DBeaver as a CSV file and store it in view of the analysis in this file: */wikidata_exploration/da1_data/birth-date-gender.csv* . It should be *visible* (easily accessible) from the analysis Python notebook
